...
logger.token('ln-app-device', function getId(req) {
  return req.headers['ln-app-device'];
});
...
module.exports = function (context, info) {
  ...
  app.use(logger(':time :method :url :status [:response-time] ms - :res[content-length] - [:ln-app-device]'));

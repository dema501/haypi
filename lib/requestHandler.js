...
module.exports = (context, opts) => {
    ...
    function cleanParamsAndCallModelFn (name, schema, params, fn, errors, req) {
        logger.info(name + " called with params:", JSON.stringify(redactValues(params, schema)));
        ...
        logger.info(name + " cleaned params:", JSON.stringify(redactValues(params, schema)));

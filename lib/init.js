...
module.exports = function (info) {
    ...
    //------------------------------------------------
    info.verbose && logger.info("STARTING UP");
    info.verbose && logger.info("INITIALIZING CONFIG VARS");
    //------------------------------------------------
    ...
    //------------------------------------------------
    info.verbose && logger.info("INITIALIZING GLOBALS")
    //------------------------------------------------
    ...
    //------------------------------------------------
    info.verbose && logger.info("ON INIT");
    //------------------------------------------------
...
function startServer (server, info, callbacks) {
    ...
    function onError (error) {
        ...
        switch (error.code) {
            case 'EACCES':
                ...
                break;
            case 'EADDRINUSE':
                logger.error("Port " + info.port + ' is already in use');
                info.port += 1;
    ...
    function onListening () {
        ...
        info.verbose && logger.info(`Listening on port ${addr.port}`);
        serverStatus.emit("started", addr.port);
    }

    function onClose (cb) {
        process.on("beforeExit", function(){
            info.verbose && logger.info("BEFORE EXIT")
        })
